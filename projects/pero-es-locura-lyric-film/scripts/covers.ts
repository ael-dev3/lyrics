...
for(const [id,file,width,height] of [['YouTubeCover','Pero-es-locura-YouTube-Thumbnail-1920x1080.jpg',1920,1080],['TikTokCover','Pero-es-locura-TikTok-Cover-Profile-1200x1600.jpg',1200,1600]] as const){
...
writeFileSync('evidence/cover-assets.json',JSON.stringify({method:'Dedicated code-native poster layouts with a frame from the original live performance at 24 seconds and the bundled lyric font; Chromium raster export. No generated replacement imagery.',artwork:'public/cover-source.png',composition:'src/CoverRoot.tsx',files:results,review:'Reviewed YouTube 320px and TikTok 150×200px proofs and 5% crop simulation: title, artist and performer remain identifiable. No platform upload preview claimed.'},null,2)+'\n');
