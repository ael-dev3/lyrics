...
if mode=='separate':
 ...
 for w in windows:
  ...
  result=model.transcribe(clip,language='en',task='transcribe',fp16=False,verbose=None,regroup=False,word_timestamps=True,condition_on_previous_text=False,beam_size=5)
