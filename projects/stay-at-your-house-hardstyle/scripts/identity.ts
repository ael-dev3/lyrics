...
export function currentIdentity(){
 ...
 return {identity:{song:'stay-hardstyle',revision:'trailer-preview-v5-action-sync',inputsSha256:createHash('sha256').update(JSON.stringify(hashes)).digest('hex')},hashes};
}
