...
[Publication verification](evidence/release-upload-verification.json) records matching SHA-256 hashes for all 16 assets downloaded from GitHub, plus the release tag, public README and final screenshot. The release archive is pinned to source commit `594ae47a94fdd1ad51a0a4584105fef6f777da99`; this verification receipt was added afterward.
