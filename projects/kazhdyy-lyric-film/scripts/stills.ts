...
for(const [format,at] of [['landscape',55.72],['landscape',72.2],['landscape',121.1],['portrait',55.72],['portrait',73.15],['portrait',121.1],['landscape',8],['portrait',8],['landscape',187.93]] as const){
