...
if(decodedPcmSha256!==JSON.parse(readFileSync('source/input-manifest.json','utf8')).audio.originalFloatPcmHash.replace(/^SHA256=/,''))throw Error('Decoded original PCM identity changed');
