...
writeFileSync('evidence/cover-assets.json',JSON.stringify({method:'Dedicated code-native SVG poster layouts reusing the AI-assisted Moon asset with an sRGB saturation-zero display filter and bundled font; raster exported by Chromium without stretching.',artwork:'public/moon-v2.png',composition:'src/CoverRoot.tsx',files:results,review:'Reviewed YouTube 320px and TikTok 150×200px proofs and 5% crop simulation: title, artist and Moon remain identifiable. No platform upload preview claimed.'},null,2)+'\n');
