...
if(decodedPcmSha256!==JSON.parse(readFileSync('evidence/source-audio-identity.json','utf8')).decodedPcmSha256)throw Error('Decoded original PCM identity changed');
