...
execFileSync('ffmpeg',[
 ...
 '-map','0:v:0','-map','1:a:0','-vf',`settb=1/${FPS},setpts=N,scale=${portrait?'1080:1920':'1920:1080'}:flags=lanczos:out_color_matrix=bt709,format=yuv420p,setsar=1`,
 '-r',String(FPS),'-fps_mode','cfr','-frames:v',String(FRAMES),
