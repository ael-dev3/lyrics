...
Selected v4 stills were checked in both layouts, including shop, train, airship, and cat moments. They establish visual composition at those times, not gait smoothness, word timing by ear, phone-size readability, or whole-film continuity. Later final MP4s received complete decode and sampled encoded-picture checks in the [production record](PRODUCTION-NOTES.md). The current word map remains provisional and the film has not passed a full sync review.
