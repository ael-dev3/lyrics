...
const b=readFileSync('../prygay-source/analysis.f32'),pcm=new Float32Array(b.buffer,b.byteOffset,b.byteLength/4),n=pcm.length/2,frames=Math.ceil(n/sr*fps),prefix=new Float64Array(n+1);
