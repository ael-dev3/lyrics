...
- a zero-phase temporally and spatially smoothed bottom spectrum with a restrained ember/teal bar palette, at least 96 px of measured core travel, and a distinct transient cap of up to 18 px;
