...
The subsequent [La Lune celestial correction](../projects/la-lune-acoustic-lyric-film/CELESTIAL-NOTES.md) records a direct visual-revision and replacement-delivery instruction after the completed edition. Its corrected preview was technically inspected before production, v3 preview acceptance remains unclaimed, and the prior approved audio, timing, text, mappings and geometry must remain hash-identical. The current visual audit and exact production inputs are bound separately. This narrowly scoped correction does not turn an earlier approval into authorization for arbitrary redesigns or new songs.
