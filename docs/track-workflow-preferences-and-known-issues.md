...
- The [La Lune acoustic edition](../projects/la-lune-acoustic-lyric-film/PRODUCTION-LESSONS.md) shows how the shared workflow can support a distinct lunar composition: asset-derived colors, measured light, radial response and instrumental-only ripples. Protect the entire lifetime of an effect around vocal entrances; a safe trigger timestamp alone is insufficient. Preserve complete instrumental passages without inventing lyric events.
