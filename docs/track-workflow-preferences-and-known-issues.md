...
The delivered v1 films preserve their original map and audio, with incomplete English phrase spans retained as historical limitations. The approved revision 3 pairs complete Spanish and English constructions in 53 cues, including “te quiero / I love you,” and protects the final spoken lyric's contrast. Source acoustic events remain unchanged. Preserve earlier deliveries when issuing the corrected edition. [Current delivery](../projects/pero-es-locura-lyric-film/README.md) · [Editorial and visual lessons](../projects/pero-es-locura-lyric-film/PRODUCTION-LESSONS.md).
...
- The completed [каждый, кто делал тебе больно treatment](../projects/kazhdyy-lyric-film/PRODUCTION-LESSONS.md) establishes a section-based option: reserve the largest response for the main climax, use bounded supporting emphasis and return to baseline elsewhere. Vocal energy shapes the selected tier; it does not override the section schedule.
- Give each animated layer a clear role and compare it enabled and disabled during review. A fixed illustration can gain vocal expression through brief, protected shadow texture. Choose effects for the current imagery, preserve equal bilingual reading positions and review every intensity boundary in both formats.
- The [La Lune acoustic edition](../projects/la-lune-acoustic-lyric-film/PRODUCTION-LESSONS.md) shows how the shared workflow can support a distinct lunar composition: a distinct subject, neutral silver, steady focal illumination, catalogue-positioned stars, radial response and instrumental-only ripples. Protect the entire lifetime of an effect around vocal entrances; a safe trigger timestamp alone is insufficient. Preserve complete instrumental passages without inventing lyric events.
- The [Ведьмы woodland treatment](../projects/vedmy-lyric-film/PRODUCTION-LESSONS.md) uses a continuous autumn palette and sparse falling leaves while keeping the photograph and lyric geometry steady. Integrate audio-shaped drift velocity to avoid position jumps; protect reading areas and focal figures. Inspect botanical forms at small sizes for unintended visual associations. Nature imagery can carry the atmosphere while the spectrum remains simple.
- The [hardstyle trailer workflow](../projects/stay-at-your-house-hardstyle/WORKFLOW.md) separates section edits, within-shot action accents, lyric focus and measured spectrum response. Repeated musical peaks can use distinct footage and pacing; verify encoded source bounds, portrait framing, actual browser pictures and full-frame glyph clearance. Recognizable source-world motion may fit better than unrelated procedural imagery.
