...
4. **Make a song-specific visual brief.** Choose the image treatment, palette, reading area, spectrum form and intensity. Preserve the source frame when that best serves the footage; do not force 1920×1080 onto a wider source by habit. Compose portrait separately.
...
| Does it fit this song? | Compare enabled/disabled, quiet/strong passages and mobile/native size; remove decoration that adds distraction rather than meaning |
